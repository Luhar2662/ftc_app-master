...
public class HardwarePushbot_RBZ_Mecanum
{
    ...
    public void init(HardwareMap ahwMap) {
        ...
        ArmServoLeft = hwMap.crservo.get("ArmServoLeft");
        ArmServoRight=hwMap.crservo.get("ArmServoRight");
       ColorSensor = hwMap.colorSensor.get("sensor_color");
        capBallMotorA= hwMap.dcMotor.get("armMotor2");
        capBallMotorB= hwMap.dcMotor.get("armMotor");
//        armMotor    = hwMap.dcMotor.get("left_arm");
        ...
        capBallMotorA.setDirection(DcMotor.Direction.FORWARD);
        capBallMotorB.setDirection(DcMotorSimple.Direction.REVERSE);
        ...
        capBallMotorA.setPower(0);
        capBallMotorB.setPower(0);
  //      armMotor.setPower(0);
