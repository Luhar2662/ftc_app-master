 ...
 */
public class HardwarePushbot_RBZ_4wheel
{
    ...
    /* Constructor */
    public HardwarePushbot_RBZ_4wheel(){
    ...
    public void init(HardwareMap ahwMap) {
        ...
        leftFMotor   = hwMap.dcMotor.get("left_Fdrive");
        leftBMotor   = hwMap.dcMotor.get("left_Bdrive");
        rightFMotor  = hwMap.dcMotor.get("right_Fdrive");
        rightBMotor  = hwMap.dcMotor.get("right_Bdrive");
//        armMotor    = hwMap.dcMotor.get("left_arm");
        leftFMotor.setDirection(DcMotor.Direction.FORWARD); // Set to REVERSE if using AndyMark motors
        leftBMotor.setDirection(DcMotor.Direction.FORWARD);
        rightFMotor.setDirection(DcMotor.Direction.REVERSE);// Set to FORWARD if using AndyMark motors
